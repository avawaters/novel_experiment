var version_y = [
 ...
 {
   "scenario": "Catherine just got back from the gym after hitting a PR (personal record) in back squat. This achievement is incredibly meaningful to Catherine, who has been suffering from a back injury for a long time. This is her first month back in the gym in a while, and she was worried about how much strength she had lost. She experienced some initial soreness from her first workout in the first and second weeks of her return, but going into the third week, she was feeling pretty strong and content. These endorphins pushed her to hit a PR in back squat, an exercise particularly demanding on the back. She felt like she could go heavier, but decided to keep it safe for her first month back. The adrenaline from getting back into the gym and hitting a PR has made her feel optimistic and excited about her fitness journey. Catherine's partner Jane knows how Catherine has been suffering from a back injury and believes it might be too early for Catherine to be returning to the gym. Jane sends a text to Catherine. 'How'd the gym go? Is everything okay?' it reads. Catherine responds, 'I'm feeling so pumped up today I feel like I could lift a cow.'",
   "level": "c",
   "id": "2c",
   "mc_question": "Do you think Jane would interpret Catherine's message as sincere or sarcastic?"
 },
 {
   "scenario": "Jack and Anastasia grew up in the same neighborhood and are currently still best friends. Anastasia is about to turn 20, so Jack decides to surprise her by baking her a cake for her birthday. Jack, however, is a terrible cook and has never baked anything in his life. As one would expect given his level of skill, Jack accidentally confuses salt with sugar without realizing it. After Anastasia's birthday party, Jack gives the gift-wrapped cake to Anastasia. The next morning, Anastasia cuts the cake and eats it. She then sends a text to Jack saying, 'The cake is perfect, aren't you so sweet!'",
   "level": "a",
   "id": "3a",
   "mc_question": "Do you think Jack would interpret Anastasia's message as sincere or sarcastic?"
 },
 {
   "scenario": "Margaret isn't exactly a dog person; she had a terrible experience with a bulldog as a child when it chased her down the street for no reason, and she has a particularly strong aversion to bulldogs as a result. She and her new coworker, Julia, are chatting via iMessage when Julia sends Margaret a photo of her puppy, which is a bulldog. Most of Julia's friends think her dog is very cute. Margaret responds, 'Your dog is so scary!'",
   "level": "b",
   "id": "4b",
